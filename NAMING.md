# Prometheus product names

Date: 22 August 2026.

Jason Gale locked these colleague-facing and product names. Later work may not reverse them without Jason Gale. This page is not Sanctum.

## Locked

- Create Agent Principal is the product name for the act the laboratory called birth. The kernel write remains `birth_write`. The host path remains POST /birth.
...
Check keeps the laboratory name until Jason Gale locks a new word.

## Rule

Product pages, the later user interface headings, and colleague briefs use the locked names. Kernel identifiers and host paths stay mapped. Do not put instance identifiers into public key infrastructure names.
